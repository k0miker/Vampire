class Game {
    ...
    animate() {
      ...
      this.player.draw(this.ctx, this.backgroundX, this.backgroundY, this.mouseX, this.mouseY);
      ...
      for (let i = 0; i < this.bullets.length; i++) {
        if (
          ...
          this.bullets[i].x > this.backgroundX + window.innerWidth + this.bullets[i].width ||
          this.bullets[i].y > this.backgroundY + window.innerHeight + this.bullets[i].height
        ) {
