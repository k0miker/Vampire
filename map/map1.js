  ...
  constructor(ctx) {
    ...
    this.mapDefinition = [
      ...
      { index: 46, src: this.obstacleSheet, x: 34, y: 51 },
        ...
        {index: 107, src: this.acherSheet, x: 0, y: 17},
        {index: 108, src: this.acherSheet, x: 17, y: 17},
    ...
    this.map = [
      ...
      [39, 43, 11, 19, 18, 13, 19, 31, 95, 97, 99, 17, 31, 11, 4, 7,  2,  1,  2,  3,  0,  0],

      [39,  5, 17, 11,  0, 13, 31,  0,100,102,104,  0,  11,  0,  5,  0,  2,  5,  2,  3,  0,  0],

      [39,  5,  0,  0,  0,  4,  7,  7,  7,  8,  17,  0,  19,  0,  5,  0,  2,  5,  2,  0,  0,  0],

      [39,  5,  5,  5,  5,  5, 75, 75, 75, 75, 75,  5,  5,  5,  5,  0,  2,  5,  3,  0,  0,  0],

      [39,  5,  5,  5,  5,  5, 75,105,107,108,  5,  5,  5,  5,  5,  0,  2,  5,  3,  0,  0,  0],
