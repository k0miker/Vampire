...
export default class Map1 {
  constructor(ctx) {
    ...
    this.mapDefinition = [
      ...
      { index: 19, src: this.natureSheet, x: 34, y: 0 , pass:true ,spawn:false},
      { index: 20, src: this.natureSheet, x: 51, y: 0 , pass:true ,spawn:false},
      { index: 21, src: this.natureSheet, x: 68, y: 0 , pass:true ,spawn:false},
      { index: 22, src: this.natureSheet, x: 85, y: 0 , pass:true ,spawn:false},
      { index: 23, src: this.natureSheet, x: 0, y: 17 , pass:true ,spawn:false},
      { index: 24, src: this.natureSheet, x: 17, y: 17 , pass:true ,spawn:false},
      { index: 25, src: this.natureSheet, x: 34, y: 17 , pass:true ,spawn:false},
      { index: 26, src: this.natureSheet, x: 51, y: 17 , pass:true ,spawn:false},
      { index: 27, src: this.natureSheet, x: 68, y: 17 , pass:true ,spawn:false},
      { index: 28, src: this.natureSheet, x: 85, y: 17 , pass:true ,spawn:false},
      { index: 29, src: this.natureSheet, x: 0, y: 34 , pass:true ,spawn:false},
      { index: 30, src: this.natureSheet, x: 17, y: 34 , pass:true ,spawn:false},
      { index: 31, src: this.natureSheet, x: 34, y: 34 , pass:true ,spawn:false},
      { index: 32, src: this.natureSheet, x: 51, y: 34 , pass:true ,spawn:false},
      { index: 33, src: this.natureSheet, x: 68, y: 34 , pass:true ,spawn:false},
      { index: 34, src: this.natureSheet, x: 85, y: 34 , pass:true ,spawn:false},

      { index: 35, src: this.obstacleSheet, x: 0, y: 0 , pass:true ,spawn:false},
      { index: 36, src: this.obstacleSheet, x: 17, y: 0 , pass:true ,spawn:false},
      { index: 37, src: this.obstacleSheet, x: 34, y: 0 , pass:true ,spawn:false},
      { index: 38, src: this.obstacleSheet, x: 0, y: 17 , pass:true ,spawn:false},
      { index: 39, src: this.obstacleSheet, x: 17, y: 17 , pass:true ,spawn:false},
      { index: 40, src: this.obstacleSheet, x: 34, y: 17 , pass:true ,spawn:false},
      { index: 41, src: this.obstacleSheet, x: 0, y: 34 , pass:true ,spawn:false},
      { index: 42, src: this.obstacleSheet, x: 17, y: 34 , pass:true ,spawn:false},
      { index: 43, src: this.obstacleSheet, x: 34, y: 34 , pass:true ,spawn:false}, 
      { index: 44, src: this.obstacleSheet, x: 0, y: 51 , pass:true ,spawn:false},   
      { index: 45, src: this.obstacleSheet, x: 17, y: 51 , pass:true ,spawn:false},
      { index: 46, src: this.obstacleSheet, x: 34, y: 51 , pass:true ,spawn:false},
        ...
        { index: 59, src: this.streetSheet, x: 68, y: 0 , pass:true ,spawn:false},
        { index: 60, src: this.streetSheet, x: 85, y: 0 , pass:true ,spawn:false},
        { index: 61, src: this.streetSheet, x: 68, y: 17 , pass:true ,spawn:false},
        { index: 62, src: this.streetSheet, x: 85, y: 17 , pass:true ,spawn:false},
        { index: 63, src: this.streetSheet, x: 68, y: 34 , pass:true ,spawn:false},
        { index: 64, src: this.streetSheet, x: 85, y: 34 , pass:true ,spawn:false},
        { index: 65, src: this.streetSheet, x: 0, y: 51 , pass:true ,spawn:false},
        { index: 66, src: this.streetSheet, x: 17, y: 51 , pass:true ,spawn:false},
        { index: 67, src: this.streetSheet, x: 34, y: 51 , pass:true ,spawn:false},
        { index: 68, src: this.streetSheet, x: 51, y: 51 , pass:true ,spawn:false},
        { index: 69, src: this.streetSheet, x: 68, y: 51 , pass:true ,spawn:false},
        { index: 70, src: this.streetSheet, x: 85, y: 51 , pass:true ,spawn:false},
        { index: 71, src: this.streetSheet, x: 0, y: 68 , pass:true ,spawn:false},
        ...
        {index: 78, src: this.housesSheet, x: 51, y: 0, pass:false ,spawn:false},
